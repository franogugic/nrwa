...
<head>
    <meta charset="UTF-8">
    <title>Registracija - MovieList</title>
    <style>
...
<body>
    ...
    <div class="center">
        <div class="form-box">
            ...
            <div class="field">
                <label>Lozinka <span style="color:#666;">(min. 6 znakova)</span></label>
            ...
            <div class="switch">Već imaš račun? <a href="index.php?page=login">Prijava</a></div>
        </div>
    </div>
    ...
    <script>
        function register() {
            ...
            fetch('/movielist/public/index.php/api/auth/register', {
                method: 'POST',
            ...
            .then(data => {
                ...
                msg.textContent = 'Račun kreiran! Preusmjeravanje...';
